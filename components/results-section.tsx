...
export function ResultsSection() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[3px] bg-gradient-to-r from-cyan/0 via-cyan/60 to-cyan/0 shadow-[0_0_14px_2px_rgba(20,228,254,0.3)]" />
